...
class Contato extends CI_Controller{
    ...
    public function index(){
        ...
        if($this->input->post('enviar_email') == "enviar"){
            ...
            $this->email->cc('leadschacarasantahelena@gmail.com, paulobaronista@gmail.com, renata@spicycomm.com.br, alebertone@spicycomm.com.br');
            ...
            if($this->email->send()){
                ...
                redirect('http://www.reschacarasantahelena.com.br/contato/obrigado');
            }else{
                redirect('http://www.reschacarasantahelena.com.br/contato/fail');
            }
